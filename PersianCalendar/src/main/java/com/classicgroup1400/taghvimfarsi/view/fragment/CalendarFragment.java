...
import com.classicgroup1400.taghvimfarsi.adapter.CalendarAdapter;
...
import com.classicgroup1400.taghvimfarsi.view.activity.MainActivity;
import com.classicgroup1400.taghvimfarsi.view.dialog.SelectDayDialog;
import com.classicgroup1400.taghvimfarsi.view.sunrisesunset.SunriseSunsetView;
...
import static com.classicgroup1400.taghvimfarsi.Constants.CALENDAR_EVENT_ADD_MODIFY_REQUEST_CODE;
  ...
  //  InterstitialAd mInterstitialAd;
    ...
    private void showEvent(long jdn) {
        ...
        /*    ClickableSpan clickableSpan = new ClickableSpan() {
                ...
                public void onClick(View textView) {
                    try {
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.classicgroup1400.taghvimfarsi")));
                    } catch (ActivityNotFoundException e) { // Should be ActivityNotFoundException but we don't care really
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.classicgroup1400.p+ersiancalendar")));
                    }
                }
            };*/
           // ss.setSpan(clickableSpan, 0, title.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
